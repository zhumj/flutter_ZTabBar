...
typedef _ZLayoutCallback = void Function(List<double> xOffsets, TextDirection textDirection, double width);
...
class _ZTabLabelBar extends Flex {
  ...
  @override
  void updateRenderObject(BuildContext context, _ZTabLabelBarRenderer renderObject) {
...
class _ZChangeAnimation extends Animation<double> with AnimationWithParentMixin<double> {
...
class _ZDragAnimation extends Animation<double> with AnimationWithParentMixin<double> {
...
class _ZTabBarState extends State<ZTabBar> {
  ...
  void _initIndicatorPainter() {
    _indicatorPainter = !_controllerIsValid ? null : _ZIndicatorPainter(
  ...
  Widget build(BuildContext context) {
    ...
    if (_controller != null) {
      ...
      if (_controller.indexIsChanging) {
        ...
        final Animation<double> centerAnimation = _ZDragAnimation(_controller, tabIndex);
        wrappedTabs[tabIndex] = _buildStyledTab(wrappedTabs[tabIndex], true, centerAnimation);
        if (_currentIndex > 0) {
          final int tabIndex = _currentIndex - 1;
          final Animation<double> previousAnimation = ReverseAnimation(_ZDragAnimation(_controller, tabIndex));
          wrappedTabs[tabIndex] = _buildStyledTab(wrappedTabs[tabIndex], false, previousAnimation);
        }
        if (_currentIndex < widget.tabs.length - 1) {
          final int tabIndex = _currentIndex + 1;
          final Animation<double> nextAnimation = ReverseAnimation(_ZDragAnimation(_controller, tabIndex));
